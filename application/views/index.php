                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="home_left_img">
                            <img src="<?= base_url() ?>assets/img/banner/home-left-1.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="projects_inner row">
                <div class="col-lg-4 col-sm-6 brand web">
                    <div class="projects_item">
                        <img class="img-fluid" src="<?= base_url() ?>assets/img/projects/projects-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-sm-6 brand work">
                    <div class="projects_item">
                        <img class="img-fluid" src="<?= base_url() ?>assets/img/projects/projects-2.jpg" alt="">
                        <div class="projects_text">
                            <a href="portfolio-details.html">
                                <h4>3D Helmet Design</h4>
                            </a>
                ...
                <div class="col-lg-4 col-sm-6 work">
                    <div class="projects_item">
                        <img class="img-fluid" src="<?= base_url() ?>assets/img/projects/projects-3.jpg" alt="">
                        <div class="projects_text">
                            <a href="portfolio-details.html">
                                <h4>3D Helmet Design</h4>
                            </a>
                ...
                <div class="col-lg-4 col-sm-6 brand web">
                    <div class="projects_item">
                        <img class="img-fluid" src="<?= base_url() ?>assets/img/projects/projects-4.jpg" alt="">
                        <div class="projects_text">
                            <a href="portfolio-details.html">
                                <h4>3D Helmet Design</h4>
                            </a>
                ...
                <div class="col-lg-4 col-sm-6 brand work">
                    <div class="projects_item">
                        <img class="img-fluid" src="<?= base_url() ?>assets/img/projects/projects-5.jpg" alt="">
                        <div class="projects_text">
                            <a href="portfolio-details.html">
                                <h4>3D Helmet Design</h4>
                            </a>
                ...
                <div class="col-lg-4 col-sm-6 brand work web">
                    <div class="projects_item">
                        <img class="img-fluid" src="<?= base_url() ?>assets/img/projects/projects-6.jpg" alt="">
                        <div class="projects_text">
                            <a href="portfolio-details.html">
                                <h4>3D Helmet Design</h4>
                            </a>
        ...
        <div class="container">
            ...
            <div class="row latest_blog_inner">
                <div class="col-lg-4">
                    <div class="l_blog_item">
                        <div class="l_blog_img">
                            <img class="img-fluid" src="<?= base_url() ?>assets/img/blog/home-blog/home-blog-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="l_blog_item">
                        <div class="l_blog_img">
                            <img class="img-fluid" src="<?= base_url() ?>assets/img/blog/home-blog/home-blog-2.jpg" alt="">
                        </div>
                        <div class="l_blog_text">
                            <div class="date">
                                <a href="#">25 October, 2017 | By Mark Wiens</a>
                ...
                <div class="col-lg-4">
                    <div class="l_blog_item">
                        <div class="l_blog_img">
                            <img class="img-fluid" src="<?= base_url() ?>assets/img/blog/home-blog/home-blog-3.jpg" alt="">
                        </div>
                        <div class="l_blog_text">
                            <div class="date">
                                <a href="#">25 October, 2017 | By Mark Wiens</a>
